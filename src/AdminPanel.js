...
const AdminPanel = () => {
  ...
  const translateText = async (text) => {
    try {
      // In a production app, you would call an actual translation API here
      // This is a simple simulation of translation for demonstration
      // Replace with actual API call to a service like Google Translate
      
      // Simple mappings for common terms (demo purposes only)
      const translations = {
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      // If Japanese, create English version too
      if (language === "ja") {
        ...
        const englishData = {
          ...
          details: await translateText(details), // Translate details
          image,
          language: "en"
        };
  ...
  const handleEdit = (event) => {
    ...
    setDetails(event.details || ""); // Add details to edit form
